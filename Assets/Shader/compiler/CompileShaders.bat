set compilerpath = "E:\Programs\Vulkan\1.2.135.0\Bin32\glslc.exe"

E:\Programs\Vulkan\1.2.135.0\Bin32\glslc.exe ../TutorialFragment.frag -o ../out/TutorialFragment.spv
