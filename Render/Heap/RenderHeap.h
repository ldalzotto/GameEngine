...
POOLALLOCATOR_ALLOC_FUNCTION(PrecalculatedFlatNormal, PoolAllocator_PrecaculatedPolygonFlatNormal_PTR, PrecaculatedPolygonFlatNormal);
POOLALLOCATOR_ALLOCELEMENT_FUNCTION(PrecalculatedFlatNormal, PoolAllocator_PrecaculatedPolygonFlatNormal_PTR, PrecaculatedPolygonFlatNormal, PrecaculatedPolygonFlatNormal_HANDLE_PTR);
POOLALLOCATOR_FREEELEMENT_FUNCTION(PrecalculatedFlatNormal, PoolAllocator_PrecaculatedPolygonFlatNormal_PTR, PrecaculatedPolygonFlatNormal_HANDLE);
POOLALLOCATOR_FREEELEMENTS_FUNCTION(PrecalculatedFlatNormal, PoolAllocator_PrecaculatedPolygonFlatNormal_PTR, Array_PrecaculatedPolygonFlatNormalHANDLE_PTR);
