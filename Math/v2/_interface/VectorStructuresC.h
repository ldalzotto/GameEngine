...
ARRAY_PUSHBACKREALLOC_NONINITIALIZED_FUNCTION_PTR(Vector2i, Array_Vector2i_PTR, Vector2i);
...
ARRAY_ALLOC_FUNCTION(Vector4f, Array_Vector4f_PTR, Vector4f);
ARRAY_PUSHBACKREALLOC_FUNCTION_PTR(Vector4f, Array_Vector4f_PTR, Vector4f);
ARRAY_PUSHBACKREALLOC_NONINITIALIZED_FUNCTION_PTR(Vector4f, Array_Vector4f_PTR, Vector4f);