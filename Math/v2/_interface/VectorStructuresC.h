...
inline void Arr_PushBackRealloc_Vector3F(ARRAY_VECTOR3F_PTR p_arr, VECTOR3F_PTR p_value) { Arr_PushBackRealloc((ARRAY_PTR)p_arr, sizeof(VECTOR3F), (char*)p_value); };
