...
{
	{
		...
		_Math::Vector3<float> l_direction = _Math::Vector_rotate(_Math::Vector3<float> { 1.0f, 0.0f, 0.0f }, _Math::Quaternion_rotateAround(_Math::Vector3<float>{0.0f, 1.0f, 0.0f}, 2.0f));
