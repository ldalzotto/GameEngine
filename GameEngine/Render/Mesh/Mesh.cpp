...
namespace _GameEngine::_Render
{
	Mesh* Mesh_alloc(MeshAllocInfo* p_meshAllocInfo)
	{
		...
		l_mesh->MeshUniqueKey = *p_meshAllocInfo->MeshUniqueKey;
		l_mesh->Vertices = *p_meshAllocInfo->Vertices;
		l_mesh->Indices = *p_meshAllocInfo->Indices;

		{
			...
			VulkanBuffer_alloc(&l_mesh->VertexBuffer, &l_vertexBufferAllocInfo, p_meshAllocInfo->Device);
			...
			VulkanBuffer_pushToGPU(&l_vertexStagingBuffer, p_meshAllocInfo->Device, l_mesh->Vertices.data(), static_cast<size_t>(l_vertexStagingBuffer.BufferAllocInfo.Size));
...

		{
			...
			VulkanBuffer_alloc(&l_mesh->IndicesBuffer, &l_indexBufferAllocInfo, p_meshAllocInfo->Device);
			...
			VulkanBuffer_pushToGPU(&l_indexStaggingBuffer, p_meshAllocInfo->Device, l_mesh->Indices.data(), static_cast<size_t>(l_indexStaggingBuffer.BufferAllocInfo.Size));
