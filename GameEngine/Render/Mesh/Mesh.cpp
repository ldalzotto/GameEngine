...
namespace _GameEngine::_Render
{
	void Mesh_alloc(Mesh* p_mesh, MeshAllocInfo* p_meshAllocInfo)
	{
		...
		VulkanBuffer_pushToGPU(&p_mesh->VertexStaggingBuffer, p_meshAllocInfo->Device, p_mesh->Vertices.data(), static_cast<size_t>(p_mesh->VertexStaggingBuffer.BufferCreateInfo.size));
		...
		VulkanBuffer_pushToGPU(&p_mesh->IndicesStaggingBuffer, p_meshAllocInfo->Device, p_mesh->Indices.data(), static_cast<size_t>(p_mesh->IndicesStaggingBuffer.BufferCreateInfo.size));
	};
