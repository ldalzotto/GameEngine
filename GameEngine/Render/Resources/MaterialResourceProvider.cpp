...
namespace _GameEngine::_Render
{
	...
	void MaterialResourceProvider_Clear(MaterialResourceProvider* p_materialResourceProvider)
	{
		if (p_materialResourceProvider->MaterialResources.size() > 0)
		{
			...
			l_textureResourcesNotDisposed += "]";
			MYLOG_PUSH(p_materialResourceProvider->RenderInterface->MyLog, ::_Core::LogLevel::LOG_WARN, (char*)("TextureResourceProvider : Potential memory Leak. Texture resource " + l_textureResourcesNotDisposed + " wasn't disposed.").c_str());
#endif
